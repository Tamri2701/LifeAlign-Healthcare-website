                            ...
                            <div class="col-xl-7 col-lg-8 col-md-10 ">
                             <div class="hero-wrapper">
                                <div class="hero__caption">
                                    ...
                                    <p data-animation="fadeInUp" data-delay=".6s">Take the servies<br> And make your life easy.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row align-items-center justify-content-between">
                    <div class="col-xl-7 col-lg-9 col-md-8">
                        <div class="wantToWork-caption wantToWork-caption2">
                            ...
                            <p>And to know about own health is the<br>first step one can take to make sure. </p>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="single-cat text-center mb-50">
                        ...
                        <div class="cat-cap">
                            <h5><a href="services.html">Vaccinations</a></h5>
                            <p>A vaccine drop is the guarantee for the future health. Take your shot and keep your family away from worry.</p>
                            <a href="vaccinenation reghistration\vacci.php" class="plus-btn"><i class="ti-plus"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="single-cat text-center mb-50">
                        ...
                        <div class="cat-cap">
                            <h5><a href="appointment.php">Appointments</a></h5>
                            <p>Make the Appointment and connect to our doctors. Take sometime form the day and get your check done.</p>
                            <a href="appointment.php" class="plus-btn"><i class="ti-plus"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="single-cat text-center mb-50">
                        ...
                        <div class="cat-cap">
                            <h5><a href="donation.php">Organ Donation</a></h5>
                            <p>Save lives, even after you're gone.
                                Your decision to donate organs can be someone's second chance at life.
                            </p>
                            <a href="OrganDonation.php" class="plus-btn"><i class="ti-plus"></i></a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-6 col-md-12">
                        ...
                        <div class="about-img">
                            <div class="about-font-img">
                                <img src="assets/img/gallery/docotor3.jpg" alt="">
                            </div>
                        </div>
                    </div>
                </div>
